      ...
      <div className="pb-5">
        <div className="flex justify-between item-center">
          ...
          <div className="relative py-2 group">
            ...
            />
            <div className="absolute top-full right-0 2-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block">
              <p
      ...
      <div className="flex flex-col">
        {userDummyData.map((user, index) => (
          <div
            ...
            key={index }
            className={`relative flex items-center gap-2 p-2 p1-4 rounded cursor-pointer max-sm:text-sm${selectedUser?._id === user._id && "bg-[#282142]/50"}`}
          >
            <img
